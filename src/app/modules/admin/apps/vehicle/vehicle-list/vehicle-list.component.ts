...
export class VehicleListComponent implements OnInit {
  ...
  page: number = 1;
      ...
      checkboxes = [
        ...
        { label: 'Registration Number', element:'RegNumber', isChecked: true },
        { label: 'Chassis No', element:'ChassisNo', isChecked: true },
        { label: 'Model No', element:'ModelNo', isChecked: true },
      ...
      ngOnInit(): void {
          this.BookingSystemService.getArray("vehicle")
