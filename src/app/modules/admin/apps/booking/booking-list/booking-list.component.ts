...
export class BookingListComponent implements OnInit, AfterViewInit {
  ...
  checkboxes = [
    { label: 'Customer Name', element:'CustName', isChecked: true },
    { label: 'Driver Name', element:'DriName', isChecked: true },
    { label: 'Vehicle', element:'Vehicle', isChecked: true },
    { label: 'Type', element:'Type', isChecked: true },
    { label: 'Start Place', element:'StartPlace', isChecked: true },
    { label: 'End Place', element:'EndPlace', isChecked: true },
  ];
   ...
   constructor(
    ...
    ngOnInit(): void {
      this.BookingSystemService.getArray("booking")
