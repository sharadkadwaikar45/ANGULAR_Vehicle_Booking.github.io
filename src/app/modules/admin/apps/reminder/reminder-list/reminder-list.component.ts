...
export class ReminderListComponent implements OnInit {
  @ViewChild(MatPaginator) paginatior: MatPaginator;
    ...
    displayedColumns: string[] = ['Sr.No', 'VehicleNo', 'VehicleName', 'Driver', 'Type', 'Date'];
    displayedColumns2: string[] = ['Sr.No', 'VehicleNo', 'VehicleName', 'Driver', 'Type', 'Date'];
    ...
    checkboxes = [
      { label: 'Vehicle No', element:'VehicleNo', isChecked: true },
      { label: 'VehicleName', element:'VehicleName', isChecked: true },
      { label: 'Driver', element:'Driver', isChecked: true },
      { label: 'Type', element:'Type', isChecked: true },
      { label: 'Date', element:'Date', isChecked: true },
    ];
    ...
    ngOnInit(): void {
        this.BookingSystemService.getArray("reminder")
