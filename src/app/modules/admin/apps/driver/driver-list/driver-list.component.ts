...
export class DriverListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['Sr.No','Name','MobileNumber','DOB','LicenseNo','LicenseExpDate','JoiningDate','Address','Status','Actions'];
  displayedColumns2: string[] = ['Sr.No','Name','MobileNumber','DOB','LicenseNo','LicenseExpDate','JoiningDate','Address','Status','Actions'];
  ...
  page: number = 1;
      ...
      checkboxes = [
        ...
        { label: 'Mobile Number', element:'MobileNumber', isChecked: true },
        { label: 'Date Of Birth', element:'DOB', isChecked: true },
        { label: 'License No', element:'LicenseNo', isChecked: true },
        { label: 'License Exp Date', element:'LicenseExpDate', isChecked: true },
        { label: 'Joining Date', element:'JoiningDate', isChecked: true },
      ];
      ...
      ngOnInit(): void {
          this.BookingSystemService.getArray("driver")
